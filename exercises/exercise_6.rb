...
@store1.employees.create(first_name: "Hugh", last_name: "Perkic", hourly_rate: 85)

@store2.employees.create(first_name: "Lian", last_name: "Chan", hourly_rate: 85)
@store2.employees.create(first_name: "Carmen", last_name: "Shen", hourly_rate: 85)
@store2.employees.create(first_name: "Ne-", last_name: "Yo", hourly_rate: 60)